...
- Playtest Prototype 0.1.9: confirm jelly translucency renders correctly, and judge bloom level, jiggle amount and burst density.
...
1. U-009 — Ledge recovery.
2. U-011 — Remaining local-player offscreen/ring-out direction guidance.
3. U-007 — Two-player Internet Host/Join proof.
4. U-014 — Low-gravity/moon party mode.
...
- Prototype 0.1.7: Geometry Fighters bodies, ledge recovery, offscreen guidance, tighter ring-out bounds.
...
- Windows builds, headless smoke tests and ordinary runtime checks passed.
